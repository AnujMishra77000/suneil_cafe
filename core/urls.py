...
from orders.views import (
    ...
    AdminCouponManageView,
    AdminOrderDetailsView,
    AdminBillingListView,
    AdminBillDetailView,
    AdminBillThermalPrintView,
    AdminBillEscPosPayloadView,
    AdminBillDefaultPrinterPrintView,
    AdminBillDirectUSBPrintView,
    AdminBillQueuePrintJobView,
    AdminBillEditView,
...
urlpatterns = [
    ...
    path('profile/', CustomerProfilePageView.as_view(), name='customer-profile-page'),
    ...
    path('order-success/', OrderSuccessPageView.as_view(), name='order-success-page'),
    ...
    path('admin-dashboard/billing/<int:bill_id>/print/escpos-payload/', AdminBillEscPosPayloadView.as_view(), name='admin-bill-escpos-payload'),
    ...
    path('admin-dashboard/billing/<int:bill_id>/print/direct-usb/', AdminBillDirectUSBPrintView.as_view(), name='admin-bill-direct-usb-print'),
    path('admin-dashboard/billing/<int:bill_id>/print/queue/', AdminBillQueuePrintJobView.as_view(), name='admin-bill-queue-print-job'),
